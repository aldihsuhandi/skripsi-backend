...
public class UserUpdateProcessor implements BaseProcessor {
    ...
    private void fillEmptyUpdateContext(UserUpdateContext updateContext, UserVO userVO) {
        updateContext.setEmail(updateContext.getEmail().isEmpty() ? updateContext.getEmail() : userVO.getEmail());
        updateContext.setPassword(updateContext.getPassword().isEmpty() ?
                FunctionUtil.hashPassword(updateContext.getPassword()) : userVO.getPassword());
        updateContext.setUsername(updateContext.getUsername().isEmpty() ?
                updateContext.getEmail() : userVO.getUsername());
        updateContext.setPhoneNumber(updateContext.getPhoneNumber().isEmpty() ?
    ...
    private void validateEmail(String email, String currentEmail) throws ShumishumiException {
        ...
        UserVO userVO = userService.queryByEmail(email);
    ...
    private void validatePhoneNumber(String phoneNumber, String currentPhoneNumber) throws ShumishumiException {
        ...
        UserVO userVO = userService.queryByPhonenumber(phoneNumber);
    ...
    private UserVO queryUserFromSession(String sessionId) {
        ...
        return userService.queryById(sessionVO.getUserId());
    }
}
