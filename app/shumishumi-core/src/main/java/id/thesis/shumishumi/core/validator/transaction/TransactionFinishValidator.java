...
public class TransactionFinishValidator implements BaseValidator {
    @Override
    public void validate(BaseRequest baseRequest) {
        ParamChecker.isNotNull(baseRequest, "request", ShumishumiErrorCodeEnum.PARAM_ILLEGAL);
        ParamChecker.isExpected(baseRequest instanceof TransactionFinishRequest, "request", ShumishumiErrorCodeEnum.PARAM_ILLEGAL);
