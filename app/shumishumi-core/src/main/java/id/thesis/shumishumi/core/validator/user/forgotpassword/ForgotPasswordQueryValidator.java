...
public class ForgotPasswordQueryValidator implements BaseValidator {
    @Override
    public void validate(BaseRequest baseRequest) {
        ParamChecker.isNotNull(baseRequest, "request", ShumishumiErrorCodeEnum.PARAM_ILLEGAL);
        ParamChecker.isExpected(baseRequest instanceof ForgotPasswordQueryRequest, "request", ShumishumiErrorCodeEnum.PARAM_ILLEGAL);
