...
public class CartController extends BaseController {
    ...
    @PostMapping("/add")
    private ResponseEntity<CartAddResult> addToCart(@RequestHeader HttpHeaders headers, @RequestBody CartAddForm form) {
    ...
    @PostMapping("/update")
    private ResponseEntity<CartUpdateResult> updateCart(@RequestHeader HttpHeaders headers, @RequestBody CartUpdateForm form) {
    ...
    @PostMapping("/query")
    private ResponseEntity<CartQueryResult> queryCart(@RequestHeader HttpHeaders headers, @RequestBody CartQueryForm form) {
    ...
    @PostMapping("/price")
    private ResponseEntity<CartCalculateResult> calculate(@RequestHeader HttpHeaders headers, @RequestBody CartCalculateForm form) {
